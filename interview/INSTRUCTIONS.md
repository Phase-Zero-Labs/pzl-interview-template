...
If you want to brush up before the interview, see `docs/background/`:
- Git best practices
- Hamilton / DAG pipelines intro
- Data asset concepts

## Questions?

Ask your interviewer! Asking good questions is part of the process.
